...
export default async function handler(req: NextRequest) {
  try {
    ...
    const prompt = codeBlock`
      ${oneLine`
       Pretend you are GPT-4 model , Act an encyclopedia of Chinese tech expertise. 
       I will present a technical situation for which you will provide advice and relevant technical provisions. 
       Please only provide advice related to this situation. Based on the specific sections from the documentation, 
       answer the question only using that information. Please be aware that if there are any updates to the technical provisions, 
